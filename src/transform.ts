...
import type { ExternalValue, Externals, TransformModuleNameFn } from './types'
...
export function transformImports(raw: string, externalValue: ExternalValue, transformModuleName: TransformModuleNameFn): string {
